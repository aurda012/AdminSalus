  ...
  */
  ...
  findCurrentSchema(firebasePath){
      ...
      chunks.map((item,index)=>{
          ...
          if(theInsertSchemaObject&&theInsertSchemaObject[item]){
  ...
  addItemToArray(name,howLongItIs){
      ...
      if(this.state.currentInsertStructure){
          if(this.state.isJustArray){
              ...
              correctPathToInsertIn=this.state.firebasePath+"/"+(parseInt(howLongItIs)+1);
          }else{
              ...
              <div className="card">
                  ...
                  <div className="card-content">
                      ...
                      <div className="material-datatables">
                          <Table deleteFieldAction={this.deleteFieldAction} fromObjectInArray={false} name={name} routerPath={this.props.route.path} isJustArray={this.state.isJustArray} sub={this.props.params&&this.props.params.sub?this.props.params.sub:""} data={this.state.arrays[name]}/>
                      </div>
                  </div>
              </div>
          </div>
          ...
          <div className="col-md-12" key={name}>
              <div className="card">
                  ...
                  <div className="card-content">
                      ...
                      <div className="material-datatables">
                          <Table deleteFieldAction={this.deleteFieldAction} fromObjectInArray={true} name={name} routerPath={this.props.route.path} isJustArray={this.state.isJustArray} sub={this.props.params&&this.props.params.sub?this.props.params.sub:""} data={this.state.elementsInArray}/>
                      </div>
                  </div>
              </div>
          </div>
      ...
      <div>
        ...
        <div className="content" sub={this.state.lastSub}>
          ...
          {/*</div>)}*/}
              ...
              {/* FIELDS */}
              {this.state.fieldsAsArray&&this.state.fieldsAsArray.length>0?(<div className="col-md-8 col-md-offset-2">
                <div className="card">
